  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <ReportCard label="Placements" value={d.placements.total} subtitle="Successful placements" />
        <ReportCard label="Conversion rate" value={`${d.applicants.conversionPct}%`} subtitle="Applied → Placed" />
      </div>

      <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
        <h3 className="text-sm font-bold text-slate-900 mb-3 flex items-center gap-2">
          <TrendingUp className="w-4 h-4 text-indigo-600" /> Funnel breakdown
        </h3>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
          ...
          <p className="text-xs text-slate-400 mt-2">From first application to placement start date.</p>
        </div>
